...
std::string format_todo(const Todo &t, const std::string &indent)
{
  ...
  oss << indent << "[" << t.id << "] " << t.title << "  (" << t.status << ")";
  if (!t.ext_info.empty())
    oss << "  note: " << t.ext_info;
  oss << "\n";
  return oss.str();
...
std::string format_empty() { return "(no todos)\n"; }
...
std::string format_usage(const std::string &prog)
{
  return "Usage:\n"
         "  " +
         prog +
         " add <title> [--status <s>] [--note <text>]\n"
         "  " +
         prog +
         " add-child <parent_id> <title> [--status <s>] [--note <text>]\n"
         "  " +
         prog +
         " list [--status <s>]\n"
         "  " +
         ...
         "  " +
         prog +
         " update <id> [--title <t>] [--status <s>] [--note <text>]\n"
         "  " +
         prog +
         " delete <id>\n"
         "  " +
